...
export default function BlogDetailClient({ blog, otherPosts }: BlogDetailClientProps) {
    ...
    // Construct BlogPosting schema dynamically for E-E-A-T
    const blogPostingSchema = {
      "@context": "https://schema.org",
      "@type": "BlogPosting",
      "@id": `https://tarkaiedtech.com/blog/${blog.slug}/#entry`,
      "headline": blog.title,
      "description": blog.description,
      "datePublished": blog.date ? new Date(blog.date).toISOString().split('T')[0] : new Date().toISOString().split('T')[0],
      "image": blog.coverImage || blog.image || "https://tarkaiedtech.com/Logo.png",
      "author": {
        "@type": "Organization",
        "name": "TARK AI Industry Expert",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": `https://tarkaiedtech.com/blog/${blog.slug}`
      }
    };

    ...
    return (
        <main className="bg-brand-lightest min-h-screen flex flex-col">
            <div className="grow pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
                <h1 className="text-[36px] sm:text-[42px] lg:text-[48px] font-bold leading-[1.15] tracking-[-0.03em] text-brand-darkest mb-8">Cookie Policy</h1>
                <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm space-y-6 text-[16px] font-normal leading-[1.65] text-gray-700 text-justify">
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">1. What are Cookies?</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">2. Why We Use Cookies</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">3. Types of Cookies We Use</h2>
                    <div className="space-y-4">
                        <div>
                            <h3 className="text-[18px] sm:text-[20px] font-semibold text-brand-dark">A. Essential Website Cookies</h3>
                            <p className="text-[15px] font-normal leading-[1.65] text-gray-600 mt-1">
                        ...
                        <div>
                            <h3 className="text-[18px] sm:text-[20px] font-semibold text-brand-dark">B. Performance and Analytics Cookies</h3>
                            <p className="text-[15px] font-normal leading-[1.65] text-gray-600 mt-1">
                        ...
                        <div>
                            <h3 className="text-[18px] sm:text-[20px] font-semibold text-brand-dark">C. Functionality Cookies</h3>
                            <p className="text-[15px] font-normal leading-[1.65] text-gray-600 mt-1">
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">4. How You Can Control Cookies</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">5. Changes to This Cookie Policy</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">6. More Information and Contact</h2>
                    <p>

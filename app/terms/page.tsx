...
const TermsPage = () => {
    return (
        <main className="bg-brand-lightest min-h-screen flex flex-col">
            <div className="grow pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
                <h1 className="text-[36px] sm:text-[42px] lg:text-[48px] font-bold leading-[1.15] tracking-[-0.03em] text-brand-darkest mb-8">Terms of Service</h1>
                <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm space-y-6 text-[16px] font-normal leading-[1.65] text-gray-700 text-justify">
                    <p className="text-[14px] text-gray-500">Last Updated: July 2, 2026</p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">1. Acceptable Use and Age Limits</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">2. Admissions, Batch Allocations &amp; Registrations</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">3. Fee Structures, Refund &amp; Cancellation Policy</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">4. Code of Conduct &amp; Classroom Ethics</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">5. Intellectual Property Rights</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">6. Educational Outcomes &amp; Placement Disclaimer</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">7. Governing Law and Jurisdiction</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">8. Contact Information</h2>
                    <p>
                        For inquiries, complaints, or policy clarifications regarding our Terms of Service, please write to:
                    </p>
                    <div className="bg-brand-lightest/40 p-5 rounded-2xl border border-brand-accent/10 mt-4 space-y-2 text-[14px]">
                        <p><strong>TARK AI EdTech Private Limited</strong></p>
                        <p>📍 Kyros Business Center, 404&amp;405, beside Ashirwad Society, Sarthana Jakat Naka, Surat, Gujarat 395013</p>

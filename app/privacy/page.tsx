    ...
    return (
        <main className="bg-brand-lightest min-h-screen flex flex-col">
            <div className="grow pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
                <h1 className="text-[36px] sm:text-[42px] lg:text-[48px] font-bold leading-[1.15] tracking-[-0.03em] text-brand-darkest mb-8">Privacy Policy</h1>
                <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm space-y-6 text-[16px] font-normal leading-[1.65] text-gray-700 text-justify">
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">1. Information We Collect</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">2. How We Use Your Information</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">3. Data Sharing and Disclosures</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">4. Children's Privacy</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">5. Data Security &amp; Retention</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">6. Your Rights</h2>
                    <p>
                    ...
                    <h2 className="text-[22px] sm:text-[24px] lg:text-[26px] font-bold text-brand-darkest mt-8 border-b pb-2 border-gray-100">7. Contact Us</h2>
                    <p>
